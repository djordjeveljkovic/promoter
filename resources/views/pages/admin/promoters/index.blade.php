                        ...
                        @forelse ($promoters as $promoter)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="{{ route('admin.promoters.edit', $promoter->id) }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">{{ __('promoters.table.action_edit') }}</a>
                                    <form action="{{ route('admin.promoters.destroy', $promoter->id) }}" method="POST" class="inline ml-3">
                                        @csrf
                                        @method('DELETE')
