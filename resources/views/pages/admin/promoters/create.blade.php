<x-layouts.app :title="__('promoters.create_form.page_title')">
    ...
    {{-- <div class="max-w-3xl mx-auto w-full rounded-lg bg-white p-6 shadow-sm dark:bg-zinc-800"> --}}
        ...
        <form method="POST" action="{{ route('admin.promoters.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center justify-end space-x-3 pt-4">
                <a href="{{ route('admin.promoters.index') }}" {{-- Corrected from 'promoters' to be consistent with admin routes --}}
