<x-layouts.app :title="__('admin_orders.page_title')">
    ...
    >
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            ...
            <a href="{{ route('promoter.orders.create') }}" class="inline-flex items-center bg-slate-800 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 dark:bg-slate-700 dark:hover:bg-slate-600 transition-colors whitespace-nowrap">
        ...
        <form method="GET" action="{{ route('admin.orders.index') }}" class="mb-6 flex flex-col w-fit sm:flex-row items-center gap-3">
            ...
            <a href="{{ route('admin.orders.index') }}" class="w-full sm:w-auto text-center px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors">
                        ...
                        @forelse ($orders as $order)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors text-xs sm:text-sm"
                                ...
                                <td class="px-3 py-2 flex flex-col whitespace-nowrap text-center font-medium">
                                    <a href="{{ route('admin.orders.show', $order->id) }}" class="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors mr-2">
