    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="max-w-2xl mx-auto w-full rounded-lg bg-white p-6 shadow-sm dark:bg-zinc-800">
            <div class="mb-6 flex items-center justify-between">
                ...
                <a href="{{ route('ticket_type.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">{!! __('ticket_types.create_form.back_to_list_link') !!}</a>
            </div>
            ...
            <form method="POST" action="{{ route('ticket_type.store') }}" enctype="multipart/form-data" class="space-y-6" id="createTicketTypeForm">
                @csrf
