                ...
                @foreach($ticketTypes as $type)
                    ...
                    <div class="p-3 bg-gray-50 dark:bg-gray-700/40 rounded-md space-y-2"
                        ...
                        <div class="flex items-center gap-2"
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('promoter_managers.sub_promoters.create_form.percentage_help') }}</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2"
                            ...
                            <span class="text-sm text-gray-600 dark:text-gray-400">RSD {{ __('promoter_managers.sub_promoters.create_form.per_ticket_suffix') }}</span>
                            <span class="text-xs text-gray-500 dark:text-gray-400">{{ __('promoter_managers.sub_promoters.create_form.fixed_help') }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
