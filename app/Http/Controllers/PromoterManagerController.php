...
class PromoterManagerController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($managers as $manager) {
            ...
            // supreme-admin alone and must not show up in team totals.
    ...
    public function dashboard()
    {
        ...
        // Private (supreme-admin) sales are excluded so they never inflate
        // a manager's team totals or show up in the manager dashboard.
